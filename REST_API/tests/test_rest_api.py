...
class TestRestApi(unittest.TestCase):
    ...
    def test_api_get_products_names(self):
        response = requests.get("http://localhost:5000/products_names")
    ...
    def test_api_get_1_product_discounts(self):
        response = requests.get("http://localhost:5000/stocks/1/1")
        self.assertEqual(response.status_code, 200)
    ...
    def test_api_get_12_products_discounts(self):
        response = requests.get("http://localhost:5000/stocks/1/12")
        self.assertEqual(response.status_code, 200)
    ...
    def test_api_get_quantity_not_available(self):
        response = requests.get("http://localhost:5000/stocks/1/100")
        self.assertEqual(response.status_code, 200)
